  ...
  return (
    <div className="w-full h-screen flex flex-col justify-between bg-white px-2 sm:px-0">
      ...
      <div className="w-full max-w-[400px] md:max-w-2xl flex gap-2 mb-20 md:mx-auto md:justify-center w-full">
        <Button onClick={handleBack} className="w-full text-base py-4 mb-4 bg-slate-700 rounded-full shadow-md">イベントリストへ戻る</Button>
        <Button onClick={() => router.push('/admin')} className="w-full text-base py-4 mb-4 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white rounded-full shadow-md">
